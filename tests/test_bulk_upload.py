...
def _build_xlsx(tmp_path: Path) -> Path:
    ...
    # KG-9000: paper work — Excel parsed "11,125" as 11125 (decimal recovery).
    ws.append([
        "KG-9000", "Unknown Artist", "A Test", 1850, None,
    ...
    # KG-9001: a sculpture — small dimensions stay as-is.
    ws.append([
        "KG-9001", "Unknown Artist", "A Sculpture", None, 50000,
...
def test_bulk_upload_routes_medium_to_classification(tmp_path: Path):
    ...
    assert by_field[("KG-9000", "classification")] == "Drawing, Collage or other Work on Paper"
    # The xlsx "Materials" column held the actual medium — should land in medium.
    assert by_field[("KG-9000", "medium")] == "Opaque watercolor on paper"
...
def test_bulk_upload_recovers_european_decimal_dimensions(tmp_path: Path):
    ...
    assert by_field[("KG-9000", "width_in")] == "11.125"
    # Sculpture's small dimensions stay as-is
    assert by_field[("KG-9001", "height_in")] == "40.0"
    assert by_field[("KG-9001", "width_in")] == "26.0"
    assert by_field[("KG-9001", "depth_in")] == "12.0"
...
def test_bulk_upload_classification_taxonomy_is_normalized(tmp_path: Path):
    ...
    assert by_field[("KG-9001", "classification")] == "Sculpture"
