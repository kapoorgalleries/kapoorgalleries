...
|---|---|---:|
| Artsy_2-16-2026.csv | title | 652 |
| Artsy_2-16-2026.csv | status | 652 |
| Artsy_2-16-2026.csv | primer_uuid | 641 |
| Artsy_2-16-2026.csv | primary_image_url | 641 |
| Artsy_2-16-2026.csv | year | 540 |
| Artsy_2-16-2026.csv | medium | 533 |
| Artsy_2-16-2026.csv | classification | 513 |
| Artsy_2-16-2026.csv | price_usd | 152 |
...
| Kapoor Galleries - Bulk upload Template Artsy.xlsx | medium | 1076 |
| Kapoor Galleries - Bulk upload Template Artsy.xlsx | year | 892 |
| Kapoor Galleries - Bulk upload Template Artsy.xlsx | height_in | 415 |
| Kapoor Galleries - Bulk upload Template Artsy.xlsx | price_usd | 390 |
| Kapoor Galleries - Bulk upload Template Artsy.xlsx | width_in | 363 |
...
| auto_resolution_rules | classification | 457 |
| auto_resolution_rules | medium | 159 |
| auto_resolution_rules | artist | 21 |
| human_resolutions | classification | 314 |
| human_resolutions | medium | 115 |
| human_resolutions | title | 8 |
| human_resolutions | price_usd | 5 |
| human_resolutions | width_in | 3 |
| human_resolutions | height_in | 2 |
| human_resolutions | status | 1 |
...
| match_workbook_summary_kg1000_1099 (partial fixture) | classification | 16 |

## Conflict counts per field
